  ...
  <section className={s.about} id="about">
    <div className={s.wrapContent}>
      ...
      <p className={s.text}>
        ...
        using React, Redux, TypeScript, along with profound knowledge in SCSS,
        HTML, and JavaScript. I deep understanding of modern technologies and
        web development standards. I possess knowledge in user interface design,
        as well as testing and debugging processes. In my free time, I solve
        tasks on Codewars and improve my English. I'm committed to continuous
